...
export default function HeaderBox() {
  return (
    <div className={styles.container}>
      ...
      <div className="flex md:flex-row flex-col items-center w-full px-[18px] py-[14px]">
        <PaperImage className={styles.paperImage} />
        <div className="flex flex-col flex-1">
          <div className={styles.textHeader}>Policy Terms</div>
          <div className={styles.textContent}>
            Casino.bet may update, amend, edit, or supplement the Casino.bet Rules
            at any time. Users will be notified of any substantial amendments to
            the rules.
          </div>
        </div>
